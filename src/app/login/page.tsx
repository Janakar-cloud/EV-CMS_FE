  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="flex min-h-screen flex-col lg:flex-row">
        <section className="relative hidden flex-1 items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-black text-white lg:flex">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#0f172a,transparent_45%)]" />
          <div className="relative z-10 max-w-lg space-y-10 px-12">
            <div className="flex items-center gap-3 text-sm uppercase tracking-[0.2em] text-slate-400">
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-700/30">
                EV
              </span>
              EV Charge Hub
            </div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <p className="italic text-slate-300">
                "Seamless, intelligent charging infrastructure management."
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md space-y-6">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                Log in to manage your chargers, payments, and fleet.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {socialProviders.map(provider => (
                <button
                  key={provider.label}
                  type="button"
                  className="flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-700 bg-slate-800/50 px-4 py-3 text-sm font-semibold text-slate-200 shadow-sm transition hover:bg-slate-700/50"
                >
